...
public class ConsultarClienteView extends JPanel{
	...
	private void placeComponents() {
		...
		String[] colunas = {"ID", "Nome", "CPF", "Nascimento", "Telefone", "Local", "CEP", "Bairro", "Cidade", "Estado"};
		Object[][] data = { {0, "", "", LocalDate.now(), "", "", "", "", "", "" } };
